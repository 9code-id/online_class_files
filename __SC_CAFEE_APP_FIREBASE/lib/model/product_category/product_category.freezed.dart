...
class _$ProductCategoryImpl implements _ProductCategory {
  ...
  @override
  String toString() {
    return 'ProductCategory(id: $id, productCategoryName: $productCategoryName, ownerId: $ownerId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, productCategoryName, ownerId);
...
abstract class _ProductCategory implements ProductCategory {
  factory _ProductCategory(
      {final String? id,
      @JsonKey(name: 'product_category_name') final String? productCategoryName,
      @JsonKey(name: 'owner_id')
      final String? ownerId}) = _$ProductCategoryImpl;
