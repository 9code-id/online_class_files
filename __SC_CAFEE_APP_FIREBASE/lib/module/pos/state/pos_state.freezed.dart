...
mixin _$PosState {
  ...
  set gridMode(bool value) => throw _privateConstructorUsedError;
...
class _$PosStateImpl implements _PosState {
  ...
  @override
  String toString() {
    return 'PosState(counter: $counter, products: $products, search: $search, gridMode: $gridMode, categoryName: $categoryName)';
  }
...
abstract class _PosState implements PosState {
  factory _PosState(
      ...
      String search,
      bool gridMode,
      String? categoryName}) = _$PosStateImpl;
